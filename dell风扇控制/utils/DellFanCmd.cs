...
namespace dell风扇控制
{
    ...
    static class DellFanCmd
    {
        ...
        public static TextBox textBox = Form1.textBox;
        /// <summary>
        ...
        public static int ProcessCommand(string[] args)
        {
            ...
            try
            {
                    ...
                    if (LoadDriver())
                    {
                        if (disableEcFanControl)
                        {
                            ...
                            textBox.Text = "Attempting to disable EC control of the fan...";
                        ...
                        else if (enableEcFanControl)
                        {
                            ...
                            textBox.Text = "Attempting to enable EC control of the fan...";
                        ...
                        textBox.Text = "Attempting to set the fan level...";
            ...
            catch (DllNotFoundException)
            {
                ...
                textBox.Text = "Unable to load DellSmbiosBzh.dll\nMake sure that the file is present.  If it is, install the required Visual C++ redistributable:\nhttps://aka.ms/vs/16/release/vc_redist.x64.exe";
                returnCode = -1;
            }
        ...
        public static bool LoadDriver()
        {
            ...
            textBox.Text = "Loading SMM I/O driver...";
            bool result = DellSmbiosBzh.Initialize();
            if (!result)
            {
                StringBuilder sb = new StringBuilder();

                String errorInfo1 = "Failed.";
                
                String errorInfo2 = "Please make sure that bzh_dell_smm_io_x64.sys is present in the working directory,";
                String errorInfo3 = "and that measures needed to allow the signature to be verified have been performed.";
                String errorInfo4 = "Also, make sure that you are running the program \"as administrator\".";

                sb.Append(errorInfo1);
                sb.Append(errorInfo2);
                sb.Append(errorInfo3);
                sb.Append(errorInfo4);
        ...
        public static void UnloadDriver()
        {
            ...
            textBox.Text = "Unloading SMM I/O driver...";
